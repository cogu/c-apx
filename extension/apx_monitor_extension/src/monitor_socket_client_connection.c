...
//////////////////////////////////////////////////////////////////////////////
static void register_msocket_handler(apx_monitor_socket_client_connection_t* self, SOCKET_TYPE* socketObject);
static void create_connection_interface_vtable(apx_monitor_socket_client_connection_t* self, apx_connection_interface_t* interface);
...
static void register_msocket_handler(apx_monitor_socket_client_connection_t* self, SOCKET_TYPE* socket_object)
{
   if (socket_object != NULL)
   {
...
static void on_socket_connected(void* arg, void* socket, const char* addr, uint16_t port)
{
   apx_monitor_socket_client_connection_t* self;
   (void)socket;
   (void)addr;
   (void)port;
#if APX_DEBUG_ENABLE
