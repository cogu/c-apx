/*****************************************************************************
* \file      testsuite_apx_es_file_map.c
* \author    Conny Gustafsson
* \date      2017-02-20
* \brief     Unit tests for APX-ES file map
*
...
static void apx_es_filemap_insert(CuTest* tc)
{
   ...
   apx_es_file_map_create(&localMap);
   apx_es_file_map_insert(&localMap, &file2);
   apx_es_file_map_insert(&localMap, &file1);
   ...
   apx_es_file_map_clear(&localMap);
   apx_es_file_map_insert(&localMap, &file1);
   apx_es_file_map_insert(&localMap, &file2);
   CuAssertIntEquals(tc, 2, localMap.curLen);
   CuAssertPtrEquals(tc, &file1, localMap.fileList[0]);
