...
// FUNCTION PROTOTYPES
//////////////////////////////////////////////////////////////////////////////
apx_node_data_t * ApxNode_Init_ButtonStatusDirect(void);
apx_node_data_t * ApxNode_GetNodeData_ButtonStatusDirect(void);
...
void ButtonStatusDirect_inPortDataWritten(void *arg, apx_node_data_t *nodeData, uint32_t offset, uint32_t len);
