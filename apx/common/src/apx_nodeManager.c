...
static bool apx_nodeManager_createInInitData(apx_node_t *node, apx_nodeData_t *nodeData);
static bool apx_nodeManager_createOutInitData(apx_node_t *node, apx_nodeData_t *nodeData);
//////////////////////////////////////////////////////////////////////////////
// GLOBAL VARIABLES
//////////////////////////////////////////////////////////////////////////////
      ...
      for (i=0;i<numNodes;i++)
      {
         ...
         if (nodeInfo != 0)
         {
               ...
               if (outDataFile != 0)
               {
                  ...
                  else
                  {
                     if (outDataFile->nodeData==0)
                     {
                        ...
                        apx_nodeManager_createOutInitData(apxNode, nodeData);
                        apx_nodeData_setNodeInfo(nodeData, nodeInfo);
            ...
            if (inDataFile != 0)
            {
               ...
               // For any reqUire port that did not get flag set - get the initdata from the definition instead
               result = apx_nodeManager_createInInitData(apxNode, nodeData);
               if (result == false)
               {
