...
#define APX_UNEXPECTED_DATA_ERROR     37
#define APX_INVALID_PROGRAM_ERROR     38
#define APX_INVALID_STATE_ERROR       39
#define APX_INVALID_INSTRUCTION_ERROR 40
#define APX_FILE_NOT_FOUND_ERROR      41
