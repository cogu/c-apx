...
/*
void apx_client_connection_default_event_handler(void* arg, apx_event_t* event)
{
   (void)arg;
   (void)event;
}
...
void apx_client_connection_unregister_event_listener(apx_client_connection_t* self, void* handle)
{
   (void)self;
   (void)handle;
}
