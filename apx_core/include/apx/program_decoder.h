...
#define apx_vm_decoder_create apx_program_decoder_create
#define apx_vm_decoder_destroy apx_program_decoder_destroy
#define apx_vm_decoder_select_program apx_program_decoder_select_program
#define apx_vm_decoder_parse_program_header apx_program_decoder_parse_program_header
#define apx_vm_decoder_parse_next_operation apx_program_decoder_parse_next_operation
#define apx_vm_decoder_get_pack_unpack_info apx_program_decoder_get_pack_unpack_info
#define apx_vm_decoder_range_check_info_int32 apx_program_decoder_range_check_info_int32
#define apx_vm_decoder_range_check_info_uint32 apx_program_decoder_range_check_info_uint32
#define apx_vm_decoder_range_check_info_int64 apx_program_decoder_range_check_info_int64
#define apx_vm_decoder_range_check_info_uint64 apx_program_decoder_range_check_info_uint64
#define apx_vm_decoder_get_field_name apx_program_decoder_get_field_name
#define apx_vm_decoder_save_program_position apx_program_decoder_save_program_position
#define apx_vm_decoder_recall_program_position apx_program_decoder_recall_program_position
#define apx_vm_decoder_has_saved_program_position apx_program_decoder_has_saved_program_position
#define apx_vm_decoder_is_first_field apx_program_decoder_is_first_field
