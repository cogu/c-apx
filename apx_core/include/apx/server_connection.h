...
struct apx_server_tag* apx_serverConnection_get_server(apx_server_connection_t* self);
...
adt_str_t* apx_serverConnection_get_tag(apx_server_connection_t const* self); //It's the callers responsibility to dispose of the returned string object
