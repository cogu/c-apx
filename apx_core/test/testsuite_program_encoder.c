...
static void test_encode_instruction_pack_uint32(CuTest* tc)
{
   apx_program_encoder_t encoder;
   apx_program_encoder_create(&encoder);
   CuAssertIntEquals(tc, APX_NO_ERROR, apx_program_encoder_encode_instruction(&encoder, APX_VM_OPCODE_PACK, APX_VM_VARIANT_UINT32, false));
   CuAssertUIntEquals(tc, 1u, adt_bytearray_length(&encoder.buffer));
...
static void test_encode_instruction_pack_uint64(CuTest* tc)
{
   apx_program_encoder_t encoder;
   apx_program_encoder_create(&encoder);
   CuAssertIntEquals(tc, APX_NO_ERROR, apx_program_encoder_encode_instruction(&encoder, APX_VM_OPCODE_PACK, APX_VM_VARIANT_UINT64, false));
   CuAssertUIntEquals(tc, 1u, adt_bytearray_length(&encoder.buffer));
...
static void test_encode_instruction_pack_record(CuTest* tc)
{
   apx_program_encoder_t encoder;
   apx_program_encoder_create(&encoder);
   CuAssertIntEquals(tc, APX_NO_ERROR, apx_program_encoder_encode_instruction(&encoder, APX_VM_OPCODE_PACK, APX_VM_VARIANT_RECORD, false));
   CuAssertUIntEquals(tc, 1u, adt_bytearray_length(&encoder.buffer));
...
static void test_encode_instruction_pack_record_array(CuTest* tc)
{
   apx_program_encoder_t encoder;
   apx_program_encoder_create(&encoder);
   CuAssertIntEquals(tc, APX_NO_ERROR, apx_program_encoder_encode_instruction(&encoder, APX_VM_OPCODE_PACK, APX_VM_VARIANT_RECORD, true));
   CuAssertUIntEquals(tc, 1u, adt_bytearray_length(&encoder.buffer));
...
static void test_encode_instruction_unpack_uint8(CuTest* tc)
{
   apx_program_encoder_t encoder;
   apx_program_encoder_create(&encoder);
   CuAssertIntEquals(tc, APX_NO_ERROR, apx_program_encoder_encode_instruction(&encoder, APX_VM_OPCODE_UNPACK, APX_VM_VARIANT_UINT8, false));
   CuAssertUIntEquals(tc, 1u, adt_bytearray_length(&encoder.buffer));
...
static void test_encode_instruction_unpack_uint16(CuTest* tc)
{
   apx_program_encoder_t encoder;
   apx_program_encoder_create(&encoder);
   CuAssertIntEquals(tc, APX_NO_ERROR, apx_program_encoder_encode_instruction(&encoder, APX_VM_OPCODE_UNPACK, APX_VM_VARIANT_UINT16, false));
   CuAssertUIntEquals(tc, 1u, adt_bytearray_length(&encoder.buffer));
...
static void test_encode_instruction_unpack_uint64(CuTest* tc)
{
   apx_program_encoder_t encoder;
   apx_program_encoder_create(&encoder);
   CuAssertIntEquals(tc, APX_NO_ERROR, apx_program_encoder_encode_instruction(&encoder, APX_VM_OPCODE_UNPACK, APX_VM_VARIANT_UINT64, false));
   CuAssertUIntEquals(tc, 1u, adt_bytearray_length(&encoder.buffer));
...
static void test_encode_instruction_unpack_uint8_array(CuTest* tc)
{
   apx_program_encoder_t encoder;
   apx_program_encoder_create(&encoder);
   CuAssertIntEquals(tc, APX_NO_ERROR, apx_program_encoder_encode_instruction(&encoder, APX_VM_OPCODE_UNPACK, APX_VM_VARIANT_UINT8, true));
   CuAssertUIntEquals(tc, 1u, adt_bytearray_length(&encoder.buffer));
...
static void test_encode_instruction_unpack_record(CuTest* tc)
{
   apx_program_encoder_t encoder;
   apx_program_encoder_create(&encoder);
   CuAssertIntEquals(tc, APX_NO_ERROR, apx_program_encoder_encode_instruction(&encoder, APX_VM_OPCODE_UNPACK, APX_VM_VARIANT_RECORD, false));
   CuAssertUIntEquals(tc, 1u, adt_bytearray_length(&encoder.buffer));
...
static void test_encode_instruction_unpack_record_array(CuTest* tc)
{
   apx_program_encoder_t encoder;
   apx_program_encoder_create(&encoder);
   CuAssertIntEquals(tc, APX_NO_ERROR, apx_program_encoder_encode_instruction(&encoder, APX_VM_OPCODE_UNPACK, APX_VM_VARIANT_RECORD, true));
   CuAssertUIntEquals(tc, 1u, adt_bytearray_length(&encoder.buffer));
...
static void test_encode_array_size_uint8(CuTest* tc)
{
   apx_program_encoder_t encoder;
   apx_program_encoder_create(&encoder);
   CuAssertIntEquals(tc, APX_NO_ERROR, apx_program_encoder_encode_array_size(&encoder, 10u, false));
...
static void test_encode_array_size_uint16(CuTest* tc)
{
   apx_program_encoder_t encoder;
   apx_program_encoder_create(&encoder);
   CuAssertIntEquals(tc, APX_NO_ERROR, apx_program_encoder_encode_array_size(&encoder, 1000u, false));
...
static void test_encode_array_size_dynamic_uint32(CuTest* tc)
{
   apx_program_encoder_t encoder;
   apx_program_encoder_create(&encoder);
   CuAssertIntEquals(tc, APX_NO_ERROR, apx_program_encoder_encode_array_size(&encoder, 100000u, true));
...
static void test_encode_limit_values_uint8(CuTest* tc)
{
   apx_program_encoder_t encoder;
   apx_program_encoder_create(&encoder);
   CuAssertIntEquals(tc, APX_NO_ERROR, apx_program_encoder_encode_limit_check_instruction(&encoder, APX_VM_VARIANT_LIMIT_CHECK_U8, 0, 255, false));
...
static void test_encode_limit_values_int16(CuTest* tc)
{
   apx_program_encoder_t encoder;
   apx_program_encoder_create(&encoder);
   CuAssertIntEquals(tc, APX_NO_ERROR, apx_program_encoder_encode_limit_check_instruction(&encoder, APX_VM_VARIANT_LIMIT_CHECK_S16, -100, 100, true));
   uint8_t const expected[] = {
...
static void test_encode_field_name(CuTest* tc)
{
   apx_program_encoder_t encoder;
   apx_program_encoder_create(&encoder);
   CuAssertIntEquals(tc, APX_NO_ERROR, apx_program_encoder_encode_field_name(&encoder, "EngineSpeed"));
...
static void test_get_program(CuTest* tc)
{
   ...
   CuAssertIntEquals(tc, APX_NO_ERROR, apx_program_encoder_encode_program_header(&encoder, APX_PACK_PROGRAM, 1u, 0u, false));
   CuAssertIntEquals(tc, APX_NO_ERROR, apx_program_encoder_encode_instruction(&encoder, APX_VM_OPCODE_PACK, APX_VM_VARIANT_UINT8, false));
   CuAssertIntEquals(tc, APX_NO_ERROR, apx_program_encoder_get_program(&encoder, &program));
