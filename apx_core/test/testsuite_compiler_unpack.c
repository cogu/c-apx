/*****************************************************************************
* \file      testsuite_compiler_unpack.c
* \author    Conny Gustafsson
* \date      2021-02-04
* \brief     Unit tests for APX compiler unpack
*
...
static void test_apx_compiler_unpack_uint8(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8, UINT8_SIZE,
      (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_UINT8 << APX_VM_INST_VARIANT_SHIFT) };
...
static void test_apx_compiler_unpack_uint8_array(CuTest* tc)
{
   ...
   apx_error_t error_code = APX_NO_ERROR;
   apx_program_t* program;
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      UINT8_SIZE * array_length,
      APX_VM_ARRAY_FLAG | (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_UINT8 << APX_VM_INST_VARIANT_SHIFT),
...
static void test_apx_compiler_unpack_uint8_array_with_range_check(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      ...
      (APX_VM_OPCODE_DATA_SIZE << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_ARRAY_SIZE_U8 << APX_VM_INST_VARIANT_SHIFT),
      2u,
      APX_VM_ARRAY_FLAG | (APX_VM_OPCODE_DATA_CTRL << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_LIMIT_CHECK_U8 << APX_VM_INST_VARIANT_SHIFT),
      0u,
      3u
   };
...
static void test_apx_compiler_unpack_dynamic_uint8_array(CuTest* tc)
{
   ...
   apx_error_t error_code = APX_NO_ERROR;
   apx_program_t* program;
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_FLAG_DYNAMIC_DATA | APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
...
static void test_apx_compiler_unpack_queued_uint8(CuTest* tc)
{
   ...
   apx_error_t error_code = APX_NO_ERROR;
   apx_program_t* program;
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_FLAG_QUEUED_DATA | APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      UINT8_SIZE + UINT8_SIZE * queue_length,
      (APX_VM_OPCODE_DATA_SIZE << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_ELEMENT_SIZE_U8_QUEUE_SIZE_U8 << APX_VM_INST_VARIANT_SHIFT), UINT8_SIZE,
      (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_UINT8 << APX_VM_INST_VARIANT_SHIFT),
      (APX_VM_OPCODE_DATA_CTRL << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_LIMIT_CHECK_U8 << APX_VM_INST_VARIANT_SHIFT),
      0u,
      7u
...
static void test_apx_compiler_unpack_int8(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      INT8_SIZE,
      (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_INT8 << APX_VM_INST_VARIANT_SHIFT) };
...
static void test_apx_compiler_unpack_int8_with_range_check(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      INT8_SIZE,
      (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_INT8 << APX_VM_INST_VARIANT_SHIFT),
      (APX_VM_OPCODE_DATA_CTRL << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_LIMIT_CHECK_S8 << APX_VM_INST_VARIANT_SHIFT),
      (uint8_t)-10,
      (uint8_t)10
   };
...
static void test_apx_compiler_unpack_int8_array(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      ...
      APX_VM_ARRAY_FLAG | (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_INT8 << APX_VM_INST_VARIANT_SHIFT),
      (APX_VM_OPCODE_DATA_SIZE << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_ARRAY_SIZE_U8 << APX_VM_INST_VARIANT_SHIFT),
      2u
   };
...
static void test_apx_compiler_unpack_int8_array_with_range_check(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      ...
      (APX_VM_OPCODE_DATA_SIZE << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_ARRAY_SIZE_U8 << APX_VM_INST_VARIANT_SHIFT),
      2u,
      APX_VM_ARRAY_FLAG | (APX_VM_OPCODE_DATA_CTRL << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_LIMIT_CHECK_S8 << APX_VM_INST_VARIANT_SHIFT),
      (uint8_t) -1,
      (uint8_t) 10
   };
...
static void test_apx_compiler_unpack_uint16(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      UINT16_SIZE,
      (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_UINT16 << APX_VM_INST_VARIANT_SHIFT) };
...
static void test_apx_compiler_unpack_uint16_array(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      ...
      APX_VM_ARRAY_FLAG | (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_UINT16 << APX_VM_INST_VARIANT_SHIFT),
      (APX_VM_OPCODE_DATA_SIZE << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_ARRAY_SIZE_U8 << APX_VM_INST_VARIANT_SHIFT),
      2u
   };
...
static void test_apx_compiler_unpack_int16(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      INT16_SIZE,
      (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_INT16 << APX_VM_INST_VARIANT_SHIFT) };
...
static void test_apx_compiler_unpack_int16_array(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      ...
      APX_VM_ARRAY_FLAG | (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_INT16 << APX_VM_INST_VARIANT_SHIFT),
      (APX_VM_OPCODE_DATA_SIZE << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_ARRAY_SIZE_U8 << APX_VM_INST_VARIANT_SHIFT),
      2u
   };
...
static void test_apx_compiler_unpack_uint32(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      UINT32_SIZE,
      (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_UINT32 << APX_VM_INST_VARIANT_SHIFT) };
...
static void test_apx_compiler_unpack_uint32_array(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      ...
      APX_VM_ARRAY_FLAG | (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_UINT32 << APX_VM_INST_VARIANT_SHIFT),
      (APX_VM_OPCODE_DATA_SIZE << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_ARRAY_SIZE_U8 << APX_VM_INST_VARIANT_SHIFT),
      2u
   };
...
static void test_apx_compiler_unpack_int32(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      INT32_SIZE,
      (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_INT32 << APX_VM_INST_VARIANT_SHIFT) };
...
static void test_apx_compiler_unpack_int32_array(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      ...
      APX_VM_ARRAY_FLAG | (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_INT32 << APX_VM_INST_VARIANT_SHIFT),
      (APX_VM_OPCODE_DATA_SIZE << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_ARRAY_SIZE_U8 << APX_VM_INST_VARIANT_SHIFT),
      2u
   };
...
static void test_apx_compiler_unpack_uint64(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      UINT64_SIZE,
      (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_UINT64 << APX_VM_INST_VARIANT_SHIFT) };
...
static void test_apx_compiler_unpack_uint64_array(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      ...
      APX_VM_ARRAY_FLAG | (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_UINT64 << APX_VM_INST_VARIANT_SHIFT),
      (APX_VM_OPCODE_DATA_SIZE << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_ARRAY_SIZE_U8 << APX_VM_INST_VARIANT_SHIFT),
      2u
   };
...
static void test_apx_compiler_unpack_int64(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      INT64_SIZE,
      (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_INT64 << APX_VM_INST_VARIANT_SHIFT) };
...
static void test_apx_compiler_unpack_int64_array(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      ...
      APX_VM_ARRAY_FLAG | (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_INT64 << APX_VM_INST_VARIANT_SHIFT),
      (APX_VM_OPCODE_DATA_SIZE << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_ARRAY_SIZE_U8 << APX_VM_INST_VARIANT_SHIFT),
      2u
   };
...
static void test_apx_compiler_unpack_bool(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      BOOL_SIZE,
      (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_BOOL << APX_VM_INST_VARIANT_SHIFT) };
...
static void test_apx_compiler_unpack_bool_array(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      ...
      APX_VM_ARRAY_FLAG | (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_BOOL << APX_VM_INST_VARIANT_SHIFT),
      (APX_VM_OPCODE_DATA_SIZE << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_ARRAY_SIZE_U8 << APX_VM_INST_VARIANT_SHIFT),
      2u
   };
...
static void test_apx_compiler_unpack_byte(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      BYTE_SIZE,
      (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_BYTE << APX_VM_INST_VARIANT_SHIFT) };
...
static void test_apx_compiler_unpack_byte_array(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      ...
      APX_VM_ARRAY_FLAG | (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_BYTE << APX_VM_INST_VARIANT_SHIFT),
      (APX_VM_OPCODE_DATA_SIZE << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_ARRAY_SIZE_U8 << APX_VM_INST_VARIANT_SHIFT),
      2u
   };
...
static void test_apx_compiler_unpack_dynamic_byte_array(CuTest* tc)
{
   ...
   apx_error_t error_code = APX_NO_ERROR;
   apx_program_t* program;
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_FLAG_DYNAMIC_DATA | APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT16,
      data_size_byte_0,
      data_size_byte_1,
      APX_VM_ARRAY_FLAG | (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_BYTE << APX_VM_INST_VARIANT_SHIFT),
...
static void test_apx_compiler_unpack_char_string(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      ...
      APX_VM_ARRAY_FLAG | (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_CHAR << APX_VM_INST_VARIANT_SHIFT),
      (APX_VM_OPCODE_DATA_SIZE << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_ARRAY_SIZE_U8 << APX_VM_INST_VARIANT_SHIFT),
      array_length
   };
...
static void test_apx_compiler_unpack_char8_string(CuTest* tc)
{
   ...
   APX_VM_ARRAY_FLAG | (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_CHAR8 << APX_VM_INST_VARIANT_SHIFT),
   (APX_VM_OPCODE_DATA_SIZE << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_ARRAY_SIZE_U8 << APX_VM_INST_VARIANT_SHIFT),
   array_length
   };
...
static void test_apx_compiler_unpack_record_u8_u16(CuTest* tc)
{
   ...
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_VARIANT_UINT8,
      ...
      (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_RECORD << APX_VM_INST_VARIANT_SHIFT),
...
static void test_apx_compiler_unpack_array_of_records(CuTest* tc)
{
   ...
   APX_VM_ARRAY_FLAG | (APX_VM_OPCODE_UNPACK << APX_VM_INST_OPCODE_SHIFT) | (APX_VM_VARIANT_RECORD << APX_VM_INST_VARIANT_SHIFT),
...
static void test_apx_compiler_unpack_dynamic_array_of_records(CuTest* tc)
{
   ...
   apx_error_t error_code = APX_NO_ERROR;
   apx_program_t* program;
   uint8_t const expected[] = { APX_VM_HEADER_VERSION_MAJOR, APX_VM_HEADER_VERSION_MINOR, APX_VM_HEADER_PROG_TYPE_UNPACK | APX_VM_HEADER_FLAG_DYNAMIC_DATA | APX_VM_VARIANT_UINT8,
